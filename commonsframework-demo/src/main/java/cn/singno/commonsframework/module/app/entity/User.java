...
@Entity
@Table(name = "User")
//@ScriptAssert(lang = "javascript", alias = "_this", script = "_this.password==_this.rPassword", message = "{user.rPassword.illegal}")
public class User implements Serializable
{
	...
	public User(String refrenceId, String name, Integer age)
	{
		super();
	...
	public User(String refrenceId, String name, Integer age, SexEnum sex, String password)
	{
		super();
		this.refrenceId = refrenceId;
		this.name = name;

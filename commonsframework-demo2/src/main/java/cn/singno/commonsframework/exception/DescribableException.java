...
public abstract class DescribableException extends RuntimeException {
	...
	private ResultStateEnum exceptionDescribable;// 异常描述
	 ...
	 */
	public DescribableException(ResultStateEnum exceptionDescribable) {
		super();
	...
	public ResultStateEnum getExceptionDescribable() {

...
public class HttpUtils
{
     ...
     */
    public static String post(String uri, HttpEntity entity)
    {
     ...
     * @return String 响应内容
     */
    public static String post(String uri, HttpEntity entity, String charset)
    {
        HttpPost postMethod = new HttpPost(uri);
        postMethod.setEntity(entity);
        return executeRequest(postMethod, charset);
    }
     ...
     * @return HttpEntity HttpEntity
     */
    private static HttpEntity getEntityFromMap(Map<String, String> map,
            String charsetName)
    {
        // 参数对象
